...
Currently DataDog's CLI is lacking some key features including support for traces/profiling, so this skill will need to evolve with the growing feature-set.
